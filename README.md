...
* my-playbook.yml – playbook used to install D*mn Vulnerable Web App (DVWA) servers
* install-elk.yml – playbook used to install ELK Server
* filebeat-playbook.yml – playbook used to install and configure Filebeat on ELK Server and DVWA servers
* metricbeat-playbook.yml – playbook used to install and configure Metricbeat on ELK Server and DVWA servers
...
*	Copy the filebeat-config.yml and metribeat-config.yml files to /etc/ansible/files.
*	Update the /etc/ansible/hosts file to include the machines on which the ELK server and Filebeat should be installed. 
